                ...
                <div class="card">
                    <div class="card-header border-0 py-3 d-flex justify-content-between align-items-center">
                        <h6 class="card-title mb-0">
                            <i class="fi fi-rr-building me-1"></i> Edit Unit Kerja
                        </h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('unit-kerja.update', $unitKerja) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm @error('kode') is-invalid @enderror"
                                    id="kode" name="kode" value="{{ old('kode', $unitKerja->kode) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control form-control-sm @error('deskripsi') is-invalid @enderror"
                                    id="deskripsi" name="deskripsi" rows="3" placeholder="Keterangan unit kerja (opsional)">{{ old('deskripsi', $unitKerja->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
