            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header border-0 pb-2">
                        <h6 class="card-title mb-0">Form Tambah Permission</h6>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('permissions.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: user-create, user-delete" required>
                                @error('name')
