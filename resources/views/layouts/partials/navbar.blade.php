                            ...
                            <ul class="list-group list-group-hover list-group-smooth list-group-unlined">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <div class="avatar avatar-xs avatar-status-danger rounded-circle me-1">
                                        <img src="{{ asset('') }}assets/images/avatar/avatar5.webp"
                                            alt="">
                                    </div>
                                    <div class="ms-2 me-auto">
            ...
            <div class="dropdown text-end ms-sm-3 ms-2 ms-lg-4">
                <a href="#" class="d-flex align-items-center py-2" data-bs-toggle="dropdown"
                    ...
                    <div class="text-end me-2 d-none d-lg-inline-block">
                        <div class="fw-bold text-dark">{{ Auth::user()->email ?? 'Unavailable' }}</div>
                        <small class="text-body d-block lh-sm">
                            <i class="fi fi-rr-angle-down text-3xs me-1"></i> {{ Auth::user()->name ?? 'Unavailable' }}
                        </small>
                    </div>
                ...
                <ul class="dropdown-menu dropdown-menu-end w-225px mt-1">
                    <li class="d-flex align-items-center p-2">
                        ...
                        <div class="ms-2">
                            <div class="fw-bold text-dark">{{ Auth::user()->name ?? 'Unavailable' }}</div>
                            <small class="text-body d-block lh-sm">{{ Auth::user()->email ?? 'Unavailable' }}</small>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('profile.index') }}">
                            <i class="fi fi-rr-user scale-1x"></i> Profil Saya
                        </a>
                    </li>
                    <li>
                        <div class="dropdown-divider my-1"></div>
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-2 text-danger"
                            ...
                            <i class="fi fi-sr-exit scale-1x"></i> Keluar
                        </a>
